...
public class Robot implements Movement{
    private final int MIN_STAMINA = 1000;
    private final int RANDOM_STAMINA = 150;
    private final double TIRED_RUN = 0.7;
    private final double TIRED_JUMP = 150;
    private String name;
    private double stamina;
    private int distanceBarrirer;

    public Robot(String name, double stamina) {
        this.name = name;
